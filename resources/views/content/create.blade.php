...
<head>
    ...
    <title>Add New Monitoring</title>
     {{-- CSS Bootstrap --}}
    ...
    <div class="card mt-5">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            @enderror" value="{{ old('title') }}" placeholder="PROJECT NAME">
                            @error('title')
                ...
                <div class="col-12 col-sm-6">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            @enderror" value="{{ old('client') }}" placeholder="CLIENT">
                            @error('client')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            @enderror" value="{{ old('name') }}" placeholder="NAME LEADER">
                            @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            @enderror" value="{{ old('email') }}" placeholder="EMAIL LEADER">
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="col-12 col-sm-6">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="progress" id="progress" class="form-control @error('progress') is-invalid
                ...
                <div class="col-12 col-sm-6">
                    <div class="col-12">
                        <img class="img-preview img-fluid rounded-lg">
                    </div>
                </div>
        ...
        <div class="card-footer">
            ...
            <button type="submit" class="btn btn-success ml-3">Save Data</button>
        </div>
         </form>
    </div>
</div>
